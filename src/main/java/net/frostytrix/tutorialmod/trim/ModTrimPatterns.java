package net.frostytrix.tutorialmod.trim;
...
public class ModTrimPatterns {
    public static final RegistryKey<ArmorTrimPattern> FROST = RegistryKey.of(RegistryKeys.TRIM_PATTERN, Identifier.of(TutorialMod.MOD_ID, "frost"));

    public static void bootstrap(Registerable<ArmorTrimPattern> context) {
        register(context, ModItems.FROST_SMITHING_TEMPLATE, FROST);
    }
